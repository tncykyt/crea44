...
cd /etc/3proxy/
wget --no-check-certificate https://raw.githubusercontent.com/Suryta6/sorpty/main/3proxy.cfg
chmod 600 /etc/3proxy/3proxy.cfg
mkdir /var/log/3proxy/
wget --no-check-certificate https://raw.githubusercontent.com/Suryta6/sorpty/main/.proxyauth
